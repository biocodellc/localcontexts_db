...
class CreateInstitutionForm(forms.ModelForm):
    class Meta:
        model = Institution
        fields = ['institution_id', 'city_or_town', 'country', 'contact_name', 'contact_email']
        widgets = {
...
class CreateInstitutionNoRorForm(forms.ModelForm):
    class Meta:
        model = Institution
        fields = ['institution_name','institution_id', 'city_or_town', 'country', 'contact_name', 'contact_email']
        error_messages = {
            'institution_name': {
