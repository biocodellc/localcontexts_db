...
class CreateProjectForm(forms.ModelForm):
    ...
    class Meta:
        model = Project
        fields = ['title', 'project_type', 'other_type', 'project_privacy', 'description', 'url', 'project_contact', 'project_contact_email', 'providers_project_id', 'publication_doi', 'project_data_guid', 'recommended_citation']
        widgets = {
            ...
            'providers_project_id': forms.TextInput(attrs={'class': 'w-100'}),
...
class EditProjectForm(forms.ModelForm):
    ...
    class Meta:
        model = Project
        fields = ['title', 'project_type', 'other_type', 'project_privacy', 'description', 'url', 'project_contact', 'project_contact_email', 'publication_doi', 'project_data_guid', 'providers_project_id', 'recommended_citation']
        widgets = {
            'title': forms.TextInput(attrs={'class': 'w-100'}),
            'other_type': forms.TextInput(attrs={'class': 'w-100'}),
            'description': forms.Textarea(attrs={'rows': 4, 'class': 'w-100'}),
