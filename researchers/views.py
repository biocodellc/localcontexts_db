...
from .forms import ConnectResearcherForm, CreateProjectForm, ProjectContributorsForm
...
def add_notice(request, pk):
    ...
    if request.method == 'POST':
        ...
        if proj_form.is_valid() and contrib_form.is_valid():
            ...
            created_notice = BCNotice.objects.create(project=proj, placed_by_researcher=researcher)
